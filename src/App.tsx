...
function LandingPage() {
  return (
    <>
      <div>
        <h2 className="primo-testo">
          Smetti di gestire il lavoro.
          <br />
          Inizia a farlo funzionare.
        </h2>
        <p>
          Flowlee trasforma il lavoro quotidiano in priorità, assegnazioni e prossimi <br />
      ...
      <div className="container-img">
        ...
        <div>
          <img src={image2} className="imghover" />
        </div>
      </div>
      <div>
      ...
      <div>
        <h2 className="secondo-testo">
          Il modo più semplice per <br />
      ...
      <div>
        ...
        <h2 className="secondo-testo">
          Scrivi, carica, parla. Al resto <br />
          pensa Flowlee
        </h2>
      </div>
      ...
      <div className="img-container-2">
        ...
        <h2 className="text-absolute">
          Scopri come <br />
          Flowlee può aiutare <br /> il tuo team
        </h2>
      </div>
      <FooterSection />
    </>
